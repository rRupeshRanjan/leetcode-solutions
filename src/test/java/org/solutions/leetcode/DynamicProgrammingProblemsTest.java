...
class DynamicProgrammingProblemsTest {
    ...
    @Test
    void testMinCostPaintHouse() {
        Map<int[][], Integer> scenarios = new HashMap<>();
        scenarios.put(new int[][]{{17, 2, 17}, {16, 16, 5}, {14, 3, 19}}, 10);
        scenarios.put(new int[][]{{7, 6, 2}}, 2);
        scenarios.put(new int[][]{{8, 12, 18}, {14, 6, 8}, {10, 9, 13}, {2, 17, 14}, {18, 18, 6}, {2, 1, 15},
                {19, 20, 2}, {18, 15, 16}, {20, 18, 18}, {15, 10, 10}, {2, 20, 18}, {14, 5, 15}, {18, 10, 12},
                {9, 17, 19}, {9, 1, 6}, {4, 4, 10}, {7, 8, 15}, {16, 17, 4}, {16, 16, 13}, {12, 7, 10}, {14, 13, 8},
                {16, 6, 18}, {10, 5, 10}, {3, 5, 11}, {9, 9, 6}, {10, 15, 19}, {4, 5, 19}, {12, 17, 17}}, 207);

        scenarios.forEach((input, expected) -> assertEquals(expected, dpProblems.minCostPaintHouse(input)));
    }

    @Test
    void testMinCostPaintHouseII() {
        Map<int[][], Integer> scenarios = new HashMap<>();
        scenarios.put(new int[][]{{17, 2, 17}, {16, 16, 5}, {14, 3, 19}}, 10);
        scenarios.put(new int[][]{{7, 6, 2}}, 2);
        scenarios.put(new int[][]{{1, 5, 3}, {2, 9, 4}}, 5);
        scenarios.put(new int[][]{{1, 3}, {2, 4}}, 5);
        scenarios.put(new int[][]{{8, 12, 18}, {14, 6, 8}, {10, 9, 13}, {2, 17, 14}, {18, 18, 6}, {2, 1, 15},
                {19, 20, 2}, {18, 15, 16}, {20, 18, 18}, {15, 10, 10}, {2, 20, 18}, {14, 5, 15}, {18, 10, 12},
                {9, 17, 19}, {9, 1, 6}, {4, 4, 10}, {7, 8, 15}, {16, 17, 4}, {16, 16, 13}, {12, 7, 10}, {14, 13, 8},
                {16, 6, 18}, {10, 5, 10}, {3, 5, 11}, {9, 9, 6}, {10, 15, 19}, {4, 5, 19}, {12, 17, 17}}, 207);
